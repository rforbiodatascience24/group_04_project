...
Removing unnecessary data in each observation with the `str_remove` function.
...
sample_data <- sample_data |> 
  ...
  mutate(sf3b1 = str_remove(sf3b1,".*: ")) |>
  mutate(srsf2 = str_remove(srsf2,".*: ")) |>
...
```{r}
counts <- read_delim(file = here("data/raw_data/GSE114922_raw_counts_GRCh38.p13_NCBI.tsv.gz"), delim = "\t")
