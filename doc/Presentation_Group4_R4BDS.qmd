...
::: {.column width="50%"}
![From: https://www.sigmaaldrich.com/](images/HD-clipboard.png){fig-align="center"}
:::
:::
...
![](images/plot_cell_fraction_plot.png){width="328" height="288"}

![](images/plot_mutations_across_samples.png){width="591"}

## Distribution of counts

::: columns
::: {.column width="50%"}
![Histogram normalized](images/plot_histogram_plot_normalized.png){fig-align="center"}
:::

::: {.column width="50%"}
![Histogram non-normalized](images/plot_histogram_plot_non_normalized.png){fig-align="center"}
:::
:::
