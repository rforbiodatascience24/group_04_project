---
title: "Group 4 Project Presentation: Gene Expression in Bone Marrow CD34+ Hematopoietic Stem and Progenitor Cells"
author:
...
:::: {.columns}
::: {.column width="50%"}
![Histogram normalized](images/plot_histogram_plot_non_normalized.png){fig-align=center width="120%"}
:::

::: {.column width="50%"}
![Histogram non-normalized](images/plot_histogram_plot_normalized.png){fig-align=center width="120%"}
:::
::::
