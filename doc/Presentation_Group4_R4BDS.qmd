...
## Introduction {data-background= here("IMG_0825.JPG")}
...
::: {.column width="50%"}
![From: https://www.sigmaaldrich.com/](here("images/HD-clipboard.png")){fig-align="center"}
:::
:::

## Materials and methods: Data Retrieval and Cleaning

![Flowchart of data aquisition and inital tidying](here("images/01_Data_loading.jpg")){fig-align="center"}

## Methods: Gene Mapping, Cleanup and DESeq2 Analysis

![Flowchart of data augmentation](here("images/02_Data_augmentation_03_join_fused.jpg")){fig-align="center"}

## Sample compositions

![](here("images/plot_cell_fraction_plot.png")){width="328" height="288"}

![](here("images/plot_mutations_across_samples.png")){width="591"}

## Distribution of counts

::: columns
::: {.column width="50%"}
![Histogram normalized](here("images/plot_histogram_plot_normalized.png")){fig-align="center"}
:::

::: {.column width="50%"}
![Histogram non-normalized](here("images/plot_histogram_plot_non_normalized.png")){fig-align="center"}
:::
:::

## Dimensionality reduction using PCA on all cells and on HSC

![](here("images/pca_plots_combined.png")){fig-align="center"}

## Clustering analysis using K-means (k = 4) and UMAP

![](here("images/plot_kmeans4_all_cells.png")){fig-align="center"}

## Differential gene expression: All samples and HSC

![](here("images/plot_DGE_volcano.png")){fig-align="center"}

## Differential gene expression across the different cell populations - MDS vs. HD

![](here("images/plot_DGE_scatter.png")){fig-align="center"}
